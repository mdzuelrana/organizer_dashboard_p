...
DATABASES = {
    'default': dj_database_url.config(
        ...
        default='postgresql://organizer_dashboard_db_user:DjJAzDweE1xqACc41eBqueh9tDDQO8B1@dpg-d5hu4tdactks7397j0fg-a.oregon-postgres.render.com/organizer_dashboard_db',
        conn_max_age=600
    )
}
# Password validation
